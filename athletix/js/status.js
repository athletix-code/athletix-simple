...
function renderAthleteList(){
  ...
  athletes.forEach(function(a,i){
    ...
    card.innerHTML='<div style="flex:1;min-width:0;">'
      ...
      +'<button onclick="event.stopPropagation();openQuickPlan(\''+a.name.replace(/'/g,"\\'")+'\')" style="background:transparent;border:1px solid var(--border2);border-radius:var(--r-xs);padding:8px 8px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:2px;color:var(--muted);min-width:40px;min-height:44px;justify-content:center;"><span style="font-size:14px;">📅</span><span style="font-size:9px;font-weight:700;letter-spacing:.06em;font-family:Montserrat,sans-serif;">PLAN</span></button>'
      +'<button onclick="event.stopPropagation();openAthleteProfile('+a.id+')" style="background:transparent;border:1px solid var(--border2);border-radius:var(--r-xs);padding:8px 8px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:2px;color:var(--muted);min-width:40px;min-height:44px;justify-content:center;"><span style="font-size:14px;">👤</span><span style="font-size:9px;font-weight:700;letter-spacing:.06em;font-family:Montserrat,sans-serif;">PROFIL</span></button>'
      +'<button onclick="deleteAthlete('+i+',event)" style="background:transparent;border:1px solid var(--border2);border-radius:var(--r-xs);padding:8px 8px;cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:2px;color:var(--muted);min-width:40px;min-height:44px;justify-content:center;"><span style="font-size:14px;">🗑</span><span style="font-size:9px;font-weight:700;letter-spacing:.06em;font-family:Montserrat,sans-serif;">USUŃ</span></button>'
