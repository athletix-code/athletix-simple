...
function showAuthScreen(){
  ...
  auth.innerHTML = '<div style="max-width:360px;width:100%;text-align:center;">'
    ...
    // Form
    +'<div id="auth-form">'
    +'<input id="auth-email" type="email" placeholder="Email" style="width:100%;padding:12px 14px;background:var(--s2);border:1px solid var(--border2);border-radius:var(--r-xs);color:var(--text);font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;margin-bottom:10px;box-sizing:border-box;"/>'
    +'<div style="position:relative;margin-bottom:10px;">'
    +'<input id="auth-pass" type="password" placeholder="Hasło (min. 6 znaków)" style="width:100%;padding:12px 44px 12px 14px;background:var(--s2);border:1px solid var(--border2);border-radius:var(--r-xs);color:var(--text);font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;box-sizing:border-box;"/>'
    ...
    +'<input id="auth-name" type="text" placeholder="Imię i nazwisko" style="width:100%;padding:12px 14px;background:var(--s2);border:1px solid var(--border2);border-radius:var(--r-xs);color:var(--text);font-family:Montserrat,sans-serif;font-size:14px;font-weight:600;margin-bottom:10px;box-sizing:border-box;"/>'
    +'</div>'
