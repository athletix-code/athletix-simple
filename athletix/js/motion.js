...
var BRIEFING_QUOTES=['Spokojnie, to tylko gra... w której oceniam Twój mózg. 🧠','Oddychaj. Skup się. I nie myśl o tym, że Cię oceniam.','Sprinterzy reagują w 120ms. Bez presji. 😏','Twoje palce są gotowe. Pytanie czy mózg nadąży.','Poprzednim razem poszło Ci... no, sam zobaczysz.','Pamiętaj: to trening. Błędy są OK. Brak prób  - nie.','Za chwilę zaczniesz. Za godzinę będziesz chciał jeszcze raz.','Jestem tylko aplikacją, ale wierzę w Ciebie. Serio.','No to co, gotowy na kolejną dawkę adrenaliny?','Dziś pobijemy rekord. Albo przynajmniej spróbujemy.','Twój mózg waży ~1.4kg ale zużywa 20% energii ciała. Czas go ćwiczyć.','Wiesz że neuroplastyczność nie ma daty ważności? Nigdy nie jest za późno.','Podobno powtórzenie to matka nauki. To Twoje kolejne powtórzenie.','Kawa wypita? Wyspany? To lecimy.','Fun fact: czytanie tego tekstu zajęło Ci ~2 sekundy. Tyle masz na reakcję.','Nie porównuj się z innymi. Porównuj się z sobą sprzed tygodnia.','Gdyby mózg był prostszy, nie bylibyśmy dość mądrzy żeby go zrozumieć.','Twoje neurony właśnie się przygotowują. Czujesz to mrowienie? Nie? To normalne.','Tym razem idź na rekord. Albo chociaż się dobrze baw.','Za chwilę Twój układ nerwowy przejdzie test. Powodzenia.','Kiedyś ludzie reagowali na dźwięk gałęzi  - teraz na zielone kółko. Ewolucja.','Wyobraź sobie że jesteś pilotem F-16. No, prawie.','Średni czas reakcji spada o 7ms rocznie. Trening to spowalnia. Więc trenuj.','Wdech... wydech... i lecimy!','Twoja kora przedczołowa właśnie się aktywuje. Dosłownie.','Nikt nie urodził się z szybkim refleksem. To się trenuje.','Co gorsza  - im więcej o tym myślisz, tym wolniej reagujesz. Paradoks.','Ostatnia szansa żeby wycofać się z godnością. Żartuję. Nie ma wycofania. 😏','Ciekawostka: Twoje oczy wykonują ~3 sakkady na sekundę podczas skanowania.','W badaniach <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC4456887/" target="_blank" style="color:#3b82f6;text-decoration:underline;">Jain et al. (2015)</a> aktywni fizycznie mieli szybszy czas reakcji.','Jesteś szybszy niż myślisz. Serio. Dane nie kłamią.','Ten level to tak naprawdę test Twojej cierpliwości. I refleksu. Głównie cierpliwości.','Gratulacje  - samo otwarcie tej gry to już więcej niż większość zrobi dziś.','Uwaga: gra może powodować uzależnienie od poprawiania własnych rekordów.','Twój hipokamp właśnie zaczął kodować nowe wspomnienie. Niech będzie dobre.','Zanim zaczniesz  - czy wiesz że mięśnie oczu to najszybsze mięśnie w ciele?','To nie jest test inteligencji. To test dyscypliny i skupienia.','Ok, dość gadania. Kciuki gotowe? To jedziemy.','Podobno 10000 godzin czyni mistrza. To Twoja godzina numer... no, nie liczyłem.','Według <a href="https://mindcrowd.org/reaction-time-as-a-measure-of-brain-health-mindcrowd-study-findings/" target="_blank" style="color:#3b82f6;text-decoration:underline;">MindCrowd</a> mężczyźni reagują średnio 34ms szybciej. Ale to średnia, nie wyrok.'];
var LEVEL_MOTIVATORS=['Wierzę w Ciebie. No... prawie na pewno.','Następny level to Twój. Weź go.','Gorzej już było. Teraz może być tylko lepiej. Albo tak samo. 😏','Skup się. Oddychaj. I nie myśl o poprzednich błędach.','Gdyby to było łatwe, każdy by to robił.','Twój mózg właśnie buduje nowe połączenia neuronalne. Dosłownie.','Za 10 sekund zapomnisz o tym tekście i będziesz w trybie walki.','Pamiętaj: postęp > perfekcja.','Ten level jest trudniejszy. Ale Ty też jesteś lepszy niż 5 minut temu.','Nic nie motywuje bardziej niż udowodnienie sobie że się da.','Ok, starczy tego coachingu. Dawaj. 🚀','Dopamina czeka na Twój sukces. Nie każ jej czekać.','Jesteś bliżej rekordu niż myślisz. Albo dalej. Kto wie. 🤷','Twoje synapsy właśnie się wzmocniły. Dziękuj długotrwałemu wzmocnieniu synaptycznemu (LTP).','Następny level to tylko cyfry na ekranie. Nie gryzą.','Czy wiesz że stres w umiarkowanych dawkach POPRAWIA performance? Więc trochę się stresuj.','Szybkość rośnie z powtórzeniami. To nie magia  - to <a href="https://backyardbrains.com/pages/the-science-of-your-reaction-time" target="_blank" style="color:#3b82f6;text-decoration:underline;">mielinizacja</a>.','Jeśli to czytasz  - znaczy że jeszcze nie straciłeś wszystkich żyć. Brawo.','Ręce na klawiaturę. Oczy na ekran. Mózg na turbo. Lecimy.','Hej, nie myśl o tym ile razy się pomyliłeś. Myśl o tym ile razy trafiłeś.','Level wyżej = Ty lepszy. Matematyka jest prosta.','Podobno Einstein miał kiepski refleks. Ale to niepotwierdzone. I nie pomaga.','To jest ten moment w filmie gdzie bohater wstaje i idzie dalej.','Twoja amygdala mówi "uciekaj". Kora przedczołowa mówi "dasz radę". Słuchaj kory.','Fun fact: neurony mogą przesyłać sygnały z prędkością 430 km/h.','Wynik nie definiuje Cię jako osoby. Ale fajnie jakby był dobry.','Ten tekst i tak zaraz zniknie. Jak Twoja wymówka żeby nie grać dalej.','Ciekawostka: po 20 minutach treningu reakcji mózg wchodzi w tryb flow. Prawie tam jesteś.','Jeszcze jeden level. I jeszcze jeden. I jeszcze... OK, widzisz schemat.','Twoja prędkość przetwarzania wzrokowego jest jak mięsień. Ćwicz albo trać.','Według <a href="https://worldathletics.org/news/news/iaaf-sprint-start-research-project-is-the-100" target="_blank" style="color:#3b82f6;text-decoration:underline;">Komi et al. (2009)</a> granica ludzkiej reakcji słuchowej to ~80ms.','Dobra wiadomość: Twój mózg się adaptuje. Zła: potrzebuje na to snu. Idź dziś wcześniej spać.','Pamiętasz swój pierwszy level? Było gorzej. Widzisz? Progres.','Za każdym razem gdy trafiasz, Twój nucleus accumbens produkuje dopaminę. Uzależniające, co?','Nie mów nikomu, ale ten level jest łatwiejszy niż wygląda. Albo nie.','Twoje ciało produkuje ~11 milionów bitów informacji na sekundę. Przetwarzasz ~50. Wybieraj mądrze.','Dwa słowa: jeszcze raz.','Ty kontra Twój mózg. Kto wygra? Obaj. Bo to ten sam team.','OK, ostatni motywujący cytat na ten level. Obiecuję. Prawie.','Oddychaj i działaj. 🔑'];
...
function _getBriefingRules(){
  ...
  if(_motionMode==='words') return '• Siatka z literami  - szukaj ukrytych słów<br>• Przesuń palcem po literach (lub kliknij pierwszą i ostatnią)<br>• Słowa mogą być poziome, pionowe lub po przekątnej<br>• Lista słów do znalezienia jest na górze ekranu';
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:16px 0 8px;">📱 Akcelerometr MEMS - maleństwo, które Cię mierzy</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">⏱️ Anatomia czasu reakcji - co się dzieje w Twoim ciele</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">🧠 Mielinizacja - jak trening dosłownie zmienia Twój mózg</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">🏅 Sprinterzy i kontrowersja 100 ms</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">🧪 Go/No-Go - dlaczego NIE reagowanie jest trudniejsze</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">🔍 Wyszukiwanie wzrokowe - Twoje oczy jako skaner</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">📊 Co wpływa na czas reakcji</div>'
+'<p><span style="font-weight:700;color:#52C97B;">POPRAWIA:</span> aktywność fizyczna, rozgrzewka, kofeina (~3-6 mg/kg), dobry sen (7-9h), nawodnienie, trening specyficzny, gry akcji (Bediou et al., 2018).</p>'
+'<p><span style="font-weight:700;color:#E24B4A;">POGARSZA:</span> wiek (~3-7 ms/rok wg <a href="https://mindcrowd.org/reaction-time-as-a-measure-of-brain-health-mindcrowd-study-findings/" target="_blank" style="color:#3b82f6;text-decoration:underline;">MindCrowd</a>), zmęczenie, brak snu, alkohol, odwodnienie, obfity posiłek, multitasking, chroniczny stres.</p>'
+'<p>Ciekawostka z MindCrowd: mężczyźni reagowali średnio o 34 ms szybciej niż kobiety.</p>'

+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">🧬 Neuroplastyczność - Twój mózg się zmienia</div>'
...
+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">🎯 Orientacyjne normy</div>'
...
+'<p style="color:#52C97B;font-weight:600;">&lt; 200 ms - Elita sportowa, piloci myśliwców</p>'
+'<p style="color:#52C97B;font-weight:600;">200-280 ms - Bardzo dobry, osoby aktywne</p>'
...
+'<p style="color:#E24B4A;font-weight:600;">&gt; 500 ms - Powód do trenowania, nie do niepokoju.</p>'

+'<div style="font-size:14px;font-weight:800;color:#52C97B;margin:20px 0 8px;">💡 Czy wiesz, że...</div>'
...
+'<div style="font-size:13px;font-weight:800;color:#52C97B;margin-bottom:8px;">📚 Spis literatury</div>'
...
function _nerdChallengeNote(){
  return '<div style="background:rgba(168,85,247,.06);border:1px solid rgba(168,85,247,.15);border-radius:12px;padding:14px;margin:16px 0;">'
    ...
    +'<div style="font-size:11px;color:#52C97B;margin-top:6px;">📧 Zgłoś: kontakt@sigmaathletix.pl</div></div>';
}
function _motionModalWrap(id,title,body){
  ...
  m.innerHTML='<div style="max-width:420px;width:calc(100% - 32px);background-color:#1a1a1a !important;color:#f2f2f2 !important;border-radius:16px;box-shadow:0 16px 48px rgba(0,0,0,.25);padding:20px;max-height:80vh;overflow-y:auto;">'
    ...
    +body
    +'<button onclick="document.getElementById(\''+id+'\').remove()" style="width:100%;padding:12px;background:rgba(82,201,123,.1);color:#52C97B;border:1px solid rgba(82,201,123,.25);border-radius:14px;font-family:Montserrat,sans-serif;font-size:14px;font-weight:800;cursor:pointer;margin-top:10px;">Rozumiem! 💪</button></div>';
...
function _charListHtml(){
  ...
  return LEVEL_CHARACTERS.map(function(c){
    ...
    return '<div style="display:flex;align-items:center;gap:8px;padding:6px 4px;border-bottom:1px solid rgba(255,255,255,.06);'+(isCurrent?'border-left:2px solid #52C97B;padding-left:6px;':'')+(unlocked?'':'opacity:.35;')+'">'
      +'<span style="font-size:20px;">'+c.emoji+'</span>'
      +'<div style="flex:1;min-width:0;"><div style="font-size:13px;font-weight:700;color:#f2f2f2;">'+c.name+' <span style="font-size:9px;color:rgba(255,255,255,.18);">Lv.'+c.level+'</span>'+(isCurrent?' <span style="font-size:9px;color:#52C97B;">← Tu jesteś</span>':'')+(unlocked?'':' <span style="font-size:10px;">🔒</span>')+'</div>'
...
function openMotionInfo(){
  var body=''
    ...
    +'<div style="font-size:24px;flex-shrink:0;">🧠</div>'
    +'<div style="flex:1;"><div style="font-size:13px;font-weight:700;color:#52C97B;">Sekcja dla nerdów</div><div style="font-size:10px;font-weight:500;color:rgba(255,255,255,.45);">Jak to NAPRAWDĘ działa? Nauka, fakty, źródła.</div></div>'
...
function openGameInfo(game){
  var data={
    ...
    gonogo:{t:'👁 Go/No-Go - Jak grać?',b:''
      +'<div style="font-size:9px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.18);margin-bottom:4px;">📋 ZASADY</div>'
      +'<div style="font-size:13px;color:#f2f2f2;line-height:1.6;margin-bottom:12px;"><span style="color:#52C97B;font-weight:800;">🟢 Zielone = REAGUJ!</span><br><span style="color:#E24B4A;font-weight:800;">🔴 Czerwone = STÓJ!</span><br><br>Twój mózg naturalnie chce reagować na każdy bodziec. Tu musisz się hamować.</div>'
      +'<div style="font-size:9px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.18);margin-bottom:4px;">⚡ PUNKTY</div>'
  ...
  var nerdTeaser='<div style="background:rgba(59,130,246,.04);border-radius:10px;padding:10px;margin-top:12px;"><div style="font-size:10px;font-weight:600;color:rgba(255,255,255,.4);">🧠 Ciekawi Cię nauka za tym? Sprawdź sekcję nerdową w opisie modułu ⚡ Czas Reakcji!</div></div>';
...
function openPatternInfo(){
  ...
  var h='<div style="max-width:420px;width:calc(100% - 32px);background-color:#1a1a1a !important;color:#f2f2f2 !important;border-radius:16px;box-shadow:0 16px 48px rgba(0,0,0,.25);padding:20px;max-height:80vh;overflow-y:auto;">'
    ...
    +'<div style="font-size:9px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:rgba(255,255,255,.18);margin-bottom:4px;">🎯 Zasady</div>'
    +'<div style="font-size:13px;color:#f2f2f2;line-height:1.6;margin-bottom:12px;">Na górze ekranu widzisz <strong style="color:#52C97B;">WZORZEC</strong> (cel) - zapamiętaj go.<br>Na dole zmieniają się różne wzorce.<br><br>Gdy dolny wzorzec <strong style="color:#52C97B;">PASUJE</strong> do górnego → reaguj!<br>Gdy <strong style="color:#E24B4A;">NIE PASUJE</strong> → nie ruszaj się.<br><br><span style="font-size:11px;color:rgba(255,255,255,.5);">📱 Ruch: przechyl w kierunku wzorca<br>👆 Dotyk: tapnij (center) lub swipe (kierunkowy)<br>💻 Komputer: kliknij (center) lub strzałki</span></div>'
    ...
    +'<div style="font-size:11px;font-weight:800;text-transform:uppercase;color:#52C97B;margin-bottom:10px;">📈 PROGRESJA POZIOMÓW</div>'
    ...
    +'</div>'
    +'<button onclick="document.getElementById(\'pattern-info-modal\').remove()" style="width:100%;padding:12px;background:rgba(82,201,123,.1);color:#52C97B;border:1px solid rgba(82,201,123,.25);border-radius:14px;font-family:Montserrat,sans-serif;font-size:14px;font-weight:800;cursor:pointer;margin-top:10px;">Rozumiem! 💪</button></div>';
...
function _confirmCloseMotion(){
  ...
  ov.innerHTML='<div style="max-width:300px;width:100%;background:#1a1a1a;border-radius:16px;padding:20px;text-align:center;">'
    ...
    +'<button id="mc-end" style="width:100%;padding:12px;background:#E24B4A;color:#fff;border:none;border-radius:10px;font-family:Montserrat,sans-serif;font-size:13px;font-weight:800;cursor:pointer;">Zakończ</button>'
...
function _showBriefing(onReady){
  ...
  ma.innerHTML='<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);text-align:center;width:100%;padding:0 28px;box-sizing:border-box;max-width:360px;">'
    ...
    +'<button id="briefing-go-btn" style="margin-top:20px;width:100%;padding:14px;background:rgba(82,201,123,.1);color:#52C97B;border:1px solid rgba(82,201,123,.25);border-radius:var(--r);font-family:Montserrat,sans-serif;font-size:15px;font-weight:900;cursor:pointer;letter-spacing:.04em;">DAWAJ! \uD83D\uDE80</button>'
    +'</div>';
...
function _mHUD(){
  ...
  function _tc(ms){ if(isSearch){ return ms<3000?'#52C97B':ms<6000?'#52C97B':ms<10000?'#d97706':'#E24B4A'; } return ms<250?'#52C97B':ms<400?'#52C97B':ms<600?'#d97706':'#E24B4A'; }
  var isWide=window.innerWidth>=768;
  var tPad=isWide?'8px 6px':'4px 4px';
  var tValFs=isWide?'18px':'14px';
  var tUnitFs=isWide?'10px':'9px';
  function _fmtTime(ms){ return isSearch?(ms/1000).toFixed(1)+'<span style="font-size:'+tUnitFs+';font-weight:700;"> s</span>':ms+'<span style="font-size:'+tUnitFs+';font-weight:700;"> ms</span>'; }
  ...
  var bestTile=tileBase+'border:2px solid rgba(212,168,67,.5);box-shadow:0 0 12px rgba(212,168,67,.15);';
  ...
  var tilesHtml='<div style="position:fixed;top:56px;left:50%;transform:translateX(-50%);width:calc(100% - 80px);max-width:340px;display:flex;gap:6px;z-index:15;">'
    +'<div style="'+lastTile+'" id="m-tile-last"><div style="font-size:'+tValFs+';font-weight:800;color:'+(hasData?_tc(lastMs):'rgba(255,255,255,.25)')+';transition:transform .2s;" id="m-last-val">'+(hasData?_fmtTime(lastMs):'\u2014')+'</div><div style="'+labelS+'">OSTATNI</div></div>'
    +'<div style="'+avgTile+'"><div style="font-size:'+tValFs+';font-weight:800;color:'+(hasData?_tc(avgMs):'rgba(255,255,255,.25)')+';">'+(hasData?_fmtTime(avgMs):'\u2014')+'</div><div style="'+labelS+'">ŚREDNIA</div></div>'
    +'<div style="'+bestTile+'"><div style="font-size:'+bestValFs+';font-weight:800;color:'+(hasData?'#52C97B':'rgba(255,255,255,.25)')+';">'+(hasData?_fmtTime(bestMs):'\u2014')+'</div><div style="'+labelS+'">NAJLEPSZY</div></div>'
    +'</div>';
  ...
  return '<div style="position:fixed;top:8px;left:50%;transform:translateX(-50%);z-index:16;display:flex;align-items:center;gap:12px;background:rgba(6,6,6,.85);padding:6px 16px;border-radius:20px;border:1px solid rgba(255,255,255,.08);max-width:340px;">'
    +'<div style="text-align:center;"><div style="font-size:16px;font-weight:900;color:'+(_gamePoints<0?'#E24B4A':'var(--accent)')+';transition:transform .2s,color .3s;" id="m-pts">⚡ '+_gamePoints+'</div><div style="'+hudLbl+'">PUNKTY</div></div>'
    ...
    +'<div style="text-align:center;"><div style="font-size:14px;font-weight:800;color:#E24B4A;transition:transform .2s;" id="m-lives">❤️ '+_gameLives+'</div><div style="'+hudLbl+'">ŻYCIA</div></div>'
    +'</div>'
    +tilesHtml+comboHtml
...
function _flashLives(){
  ...
  setTimeout(function(){ lv.style.color='#E24B4A'; lv.style.transform='scale(1)'; },300);
}
function _mTimeAnim(ms){
  var col=ms<250?'#52C97B':ms<400?'#52C97B':ms<600?'#d97706':'#E24B4A';
...
function _mCircle(state,content,subtext){
  var colors={wait:'rgba(255,255,255,.1)',go:'#52C97B',nogo:'#E24B4A',result:'rgba(255,255,255,.08)',wrong:'#E24B4A'};
  var borderC=colors[state]||'rgba(255,255,255,.1)';
  var bg=state==='go'?'#52C97B':state==='nogo'?'#E24B4A':'transparent';
  var shadow=state==='go'?'0 0 40px rgba(82,201,123,.3)':state==='nogo'?'0 0 40px rgba(226,75,74,.3)':'none';
...
function _finishTrial(clearFn,rc,rt,stimTime,correct,errType,trialResults,idx,cfg,cb){
  ...
  if(correct){
    ...
    var ma=el('motion-active');
    // Flash tła
    if(t<350) ma.style.background='rgba(82,201,123,.1)'; else if(t<500) ma.style.background='rgba(59,130,246,.08)';
...
function _showLevelComplete(lv,trialResults){
  ...
  var avgCol=lvAvg<250?'#52C97B':lvAvg<400?'#52C97B':lvAvg<600?'#d97706':'#E24B4A';
  var accCol=lvAcc>90?'#52C97B':lvAcc>70?'#52C97B':'#d97706';
  ...
  ma.innerHTML='<div style="min-height:100%;display:flex;align-items:center;justify-content:center;padding:20px;box-sizing:border-box;"><div style="text-align:center;width:100%;max-width:360px;">'
    ...
    +'<div style="'+tileS+'"><div style="font-size:20px;font-weight:900;color:#52C97B;">'+lvBest+'ms</div><div style="font-size:10px;font-weight:700;text-transform:uppercase;color:rgba(255,255,255,.55);margin-top:4px;">Najlepszy</div><div style="font-size:9px;font-weight:500;color:rgba(255,255,255,.4);margin-top:2px;">Twój najszybszy moment</div></div>'
    ...
    +'<button onclick="_nextLevel()" style="width:100%;padding:14px;background:rgba(82,201,123,.1);color:#52C97B;border:1px solid rgba(82,201,123,.25);border-radius:var(--r);font-family:Montserrat,sans-serif;font-size:15px;font-weight:900;cursor:pointer;animation:mBtnPulse 1.5s infinite;">🚀 LEVEL '+(lv+1)+' → '+nextCh.emoji+' '+nextCh.name+'</button>'
...
function _showGameOver(){
  ...
  ma.innerHTML='<div style="min-height:100%;display:flex;align-items:center;justify-content:center;padding:20px;box-sizing:border-box;"><div style="text-align:center;width:100%;max-width:360px;">'
    ...
    +'<div style="font-size:32px;font-weight:900;color:'+(_gamePoints<0?'#E24B4A':'var(--accent)')+';margin-top:4px;">⚡ '+_gamePoints+'</div>'
    ...
    +'<button onclick="_motionRetry()" style="width:100%;padding:10px;background:rgba(82,201,123,.1);color:#52C97B;border:1px solid rgba(82,201,123,.25);border-radius:var(--r);font-family:Montserrat,sans-serif;font-size:13px;font-weight:800;cursor:pointer;">🔄 Zagraj ponownie</button>'
...
function _mResultTiles(avg,best,acc){
  ...
  var avgCol=avg<250?'#52C97B':avg<400?'#52C97B':avg<600?'#d97706':'#E24B4A';
  var accCol=acc>90?'#52C97B':acc>70?'#52C97B':'#d97706';
  ...
  return '<div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:10px;max-width:320px;margin-left:auto;margin-right:auto;">'
    ...
    +tile('🏆',best,'ms','Najlepszy','#52C97B','best','')
...
function _scoringHtml(lv){
  ...
  return '<div style="background:rgba(255,255,255,.04);border-radius:10px;padding:10px;margin:10px 0;">'
    +'<div style="font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#52C97B;margin-bottom:4px;">⚡ PUNKTY W TYM LEVELU</div>'
...
function _patScoringHtml(lv){
  ...
  return '<div style="background:rgba(255,255,255,.03);border-radius:8px;padding:8px 10px;margin-top:6px;">'
    +'<div style="font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#52C97B;margin-bottom:4px;">⚡ PUNKTY</div>'
  ...
  var rc=setInterval(function(){
    ...
    if(detectMovement()||_motionState._keyPressed){
      ...
      if(isMatch){
        ...
        var sb=document.getElementById('pat-stim-box'); if(sb){ sb.style.borderColor='#52C97B'; sb.style.boxShadow='0 0 30px rgba(82,201,123,.3)'; }
        var tb=document.getElementById('pat-target-box'); if(tb){ tb.style.borderColor='#52C97B'; }
        ma.style.background='rgba(82,201,123,.06)'; setTimeout(function(){ ma.style.background='#060606'; },300);
      } else {
        ...
        errMsg.innerHTML='<div style="font-size:18px;font-weight:900;color:#E24B4A;">✕ ZMYŁKA! -2 pkt</div><div style="font-size:12px;color:rgba(255,255,255,.5);margin-top:4px;">To nie ten wzorzec!</div><div style="font-size:11px;font-weight:700;color:#E24B4A;margin-top:4px;">❤️ -1 życie!</div>';
        ...
        var pe=document.getElementById('m-pts'); if(pe){ pe.style.color='#E24B4A'; setTimeout(function(){ pe.style.color=_gamePoints<0?'#E24B4A':'var(--accent)'; },300); }
        results.push({time:t,correct:false,type:'pattern_false'});
        var sb2=document.getElementById('pat-stim-box'); if(sb2){ sb2.style.borderColor='#E24B4A'; sb2.style.boxShadow='0 0 20px rgba(226,75,74,.3)'; }
        ma.style.background='rgba(226,75,74,.06)'; setTimeout(function(){ ma.style.background='#060606'; },300);
      }
  ...
  var rt=setTimeout(function(){
    ...
    if(!reacted){
      if(isMatch){ _gameLives--; setTimeout(_flashLives,50); _gameCombo=0; _gamePoints-=1; _mPtsAnim('MISS -1','var(--red-text)'); _sndBad(); results.push({time:pc.interval,correct:false,type:'pattern_miss'});
        var sb3=document.getElementById('pat-stim-box'); if(sb3) sb3.style.borderColor='#E24B4A';
        ...
        var ck=document.createElement('div'); ck.style.cssText='position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);font-size:14px;font-weight:700;color:#52C97B;z-index:20;pointer-events:none;opacity:0;transition:opacity .2s;';
